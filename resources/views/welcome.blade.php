...
{{--  @section('content')
 ...
 <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      <div class="mb-auto">
        <div>
          <h6 class="float-left mb-0">{{-- 介護タクシー予約サイト --}}Think English</h6>
          <p class="nav nav-masthead justify-content-center float-right">{{-- 津ケアタクネット --}} Think English</p>
        </div>
      ...
      <div class="px-3">
        ...
        <p class="lead my-3">{{-- この「津ケアタクネット」では、<br>三重県津市内の介護タクシー空き状況がリアルタイムにチェックできます。 --}} Think English</p>
